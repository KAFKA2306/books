...
const RENAMES=new Map([['あかげのあん','赤毛のアン'],['ナビ付き洋書赤毛のアン','赤毛のアン'],['赤毛のアン Anne of Green Gables 英語版原文','赤毛のアン'],['ゆるきゃん','ゆるキャン'],['トーイック金のフレーズ','TOEIC 金のフレーズ'],['トーイックリスニングリーディング問題集2','TOEIC リスニング・リーディング問題集'],['トーイックテスト究極の模試','TOEIC 究極の模試'],['トーイック公式問題集','TOEIC 公式問題集'],['TOEIC公式問題集','TOEIC 公式問題集'],['トーイック公式問題集新形式対応版','TOEIC 公式問題集'],['TOEFLあいてぃーぴー直前模試','TOEFL ITP直前模試'],['かふか短編集','カフカ短編集'],['世界の終わりとハードボイルドワンダーランど','世界の終わりとハードボイルド・ワンダーランド'],['騎士団長ゴロシ','騎士団長殺し']]);
